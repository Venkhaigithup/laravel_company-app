...
<head>
    ...
    @vite(['resources/css/app_fonawsome.css', 'resources/js/app.js'])
...
<body>
    ...
    <div class="mx-auto max-w-2xl items-center sm:px-6 lg:max-w-7xl lg:px-8 bg-slate-300">
    ...
    -->
        ...
        {{-- girl style --}}
        <div class="bg-white mb-12 flex font-sans mx-auto max-w-2xl items-center sm:px-6 lg:max-w-7xl lg:px-8">
        ...
        {{-- bootstrap scroll vertical and horoz--}}
        <div class="bg-white mb-6 font-sans mx-auto max-w-2xl items-center sm:px-6 lg:max-w-7xl lg:px-8">
        ...
        {{-- vertical scroll--}}
        <div class="bg-white mb-10 flex font-sans mx-auto max-w-2xl items-center sm:px-6 lg:max-w-7xl lg:px-8">
    ...
    {{-- footer --}}
    <footer class="relative bg-[#111827] pt-32 pb-6 text-gray-400">
        <div class="container mx-auto px-4">
            <div class="flex flex-wrap">
                <div class="w-full lg:w-5/12 px-4">
                    ...
                    <h5 class="mt-10 text-lg mb-2 text-gray-400 hover:text-gray-200">
                        Making the world a better place through constructing <br>elegant hierarchies.
                    </h5>
                    <div class="mt-6">
                        <button class="bg-[#111827] text-gray-500 rounded-full mr-2 p-2" type="button">
                            <i class="flex fab fa-facebook-square fa-2x" aria-hidden="true"></i>
                        </button><button class="bg-[#111827] text-gray-500 rounded-full mr-2 p-2" type="button">
                            <i class="flex fab fa-twitter fa-2x" aria-hidden="true"></i>
                        </button><button class="bg-[#111827] text-gray-500 rounded-full mr-2 p-2" type="button">
                            <i class="flex fab fa-dribbble fa-2x" aria-hidden="true"></i>
                        </button><button class="bg-[#111827] text-gray-500 rounded-full mr-2 p-2" type="button">
                            <i class="flex fab fa-github fa-2x" aria-hidden="true"></i>
                        </button><button class="bg-[#111827] text-gray-500 rounded-full mr-2 p-2" type="button">
                ...
                <div class="w-full lg:w-7/12 px-4">
                    <div class="flex flex-wrap items-top mb-6">
                        ...
                        <div class="w-full lg:w-3/12 px-0 ml-auto">
                            <span class="block uppercase text-white text-sm font-semibold mb-4">Solutions</span>
                            <ul class="list-unstyled">
                                <li class="mb-4">
                                    <a class="text-gray-400 hover:text-gray-200 font-semibold block pb-2 text-sm" href="https://www.creative-tim.com/presentation">Marketing</a>
                                </li>
                                <li class="mb-4">
                                    <a class="text-gray-400 hover:text-gray-200 font-semibold block pb-2 text-sm" href="https://blog.creative-tim.com">Analytics</a>
                                </li>
                                <li class="mb-4">
                                    <a class="text-gray-400 hover:text-gray-200 font-semibold block pb-2 text-sm" href="https://www.github.com/creativetimofficial">Commerce</a>
                                </li>
                                <li class="mb-4">
                                    <a class="text-gray-400 hover:text-gray-200 font-semibold block pb-2 text-sm" href="https://www.github.com/creativetimofficial">Insights</a>
                                </li>
                            </ul>
                        </div>

                        <div class="w-full lg:w-3/12 px-10 ml-auto">
                            <span class="block uppercase text-white text-sm font-semibold mb-4">Support</span>
                            <ul class="list-unstyled">
                                <li class="mb-4">
                                    <a class="text-gray-400 hover:text-gray-200 font-semibold block pb-2 text-sm" href="https://www.creative-tim.com/presentation">Pricing</a>
                                </li>
                                <li class="mb-4">
                                    <a class="text-gray-400 hover:text-gray-200 font-semibold block pb-2 text-sm" href="https://blog.creative-tim.com">Documentation</a>
                                </li>
                                <li class="mb-4">
                                    <a class="text-gray-400 hover:text-gray-200 font-semibold block pb-2 text-sm" href="https://www.github.com/creativetimofficial">Guides</a>
                                </li>
                                <li class="mb-4">
                                    <a class="text-gray-400 hover:text-gray-200 font-semibold block pb-2 text-sm" href="https://www.creative-tim.com/bootstrap-themes/free">API Status</a>
                                </li>
                            </ul>
                        </div>

                        <div class="w-full lg:w-3/12 px-16 ml-auto">
                            <span class="block uppercase text-white text-sm font-semibold mb-4">Company</span>
                            <ul class="list-unstyled">
                                <li class="mb-4">
                                    <a class="text-gray-400 hover:text-gray-200 font-semibold block pb-2 text-sm" href="https://github.com/creativetimofficial/argon-design-system/blob/master/LICENSE.md">About</a>
                                </li>
                                <li class="mb-4">
                                    <a class="text-gray-400 hover:text-gray-200 font-semibold block pb-2 text-sm" href="https://creative-tim.com/terms">Blog</a>
                                </li>
                                <li class="mb-4">
                                    <a class="text-gray-400 hover:text-gray-200 font-semibold block pb-2 text-sm" href="https://creative-tim.com/privacy">Jobs</a>
                                </li>
                                <li class="mb-4">
                                    <a class="text-gray-400 hover:text-gray-200 font-semibold block pb-2 text-sm" href="https://creative-tim.com/contact-us">Press</a>
                                </li>
                            </ul>
                        </div>

                        <div class="w-full lg:w-3/12 px-20 ml-auto">
                            <span class="block uppercase text-white text-sm font-semibold mb-4">Legal</span>
                            <ul class="list-unstyled">
                                <li class="mb-4">
                                    <a class="text-gray-400 hover:text-gray-200 font-semibold block pb-2 text-sm" href="https://creative-tim.com/terms">Claim</a>
                                </li>
                                <li class="mb-4">
                                    <a class="text-gray-400 hover:text-gray-200 font-semibold block pb-2 text-sm" href="https://creative-tim.com/privacy">Privacy</a>
                                </li>
                                <li class="mb-4">
                                    <a class="text-gray-400 hover:text-gray-200 font-semibold block pb-2 text-sm" href="https://creative-tim.com/contact-us">Terms</a>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div>
                <div class="text-sm text-gray-600 font-semibold py-1">
                    Copyright © Tailwind Starter Kit by venkhai sam
                    <a href="" class="text-gray-600 hover:text-gray-200">Creative venkhai</a>.
                </div>
            </div>
        </div>
    </footer>
